 ...
 * @author logic
 */
public class PublishercontactBean implements Serializable {
    private Integer id;
    ...
    public PublishercontactBean() {
    }

    public PublishercontactBean(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PublishercontactBean)) {
            return false;
        }
        PublishercontactBean other = (PublishercontactBean) object;
